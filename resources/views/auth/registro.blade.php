...
<div class="md:flex md:justify-center md:items-center">
    ...
    <div class="md:w-6/12 bg-comentary p-6 rounded-lg shadow-lg border">
        ...
        <p class="text-2xl text-center font-bold color-comentari">{{__('traslate.registrer.join')}}<span class="color-comentari">Devstagram</span><span>, {{__('traslate.registrer.already')}} {{$userCount}}</span></p>
        <br>
        <hr>
        <br>
        <form action="{{route('crear')}}" method="POST" novalidate>
            ...
            <div class="relative mb-3">
                <input type="text" id="name" name="name" type="text" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('name') border-red-500 @enderror" placeholder=" "
                value="{{ old('name')}}"/>
                @error('name')
            ...
            <div class="relative mb-3">
                <input type="text" id="username" name="username" type="text" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('name') border-red-500 @enderror" placeholder=" "
                value="{{ old('username')}}"/>
                @error('username')
                    <p class="text-red-700">{{ $message }}</p>
                @enderror
            ...
            <div class="relative mb-3">
                <input type="password" id="password_confirmation" name="password_confirmation" type="text" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " 
                />
            ...
            <input type="submit"
            value="{{__('traslate.registrer.create')}}"
        ...
        <br>
        <p class="text-center font-bold">{{__('traslate.registrer.acounte')}}<span><a class="text-blue-500 hover:text-blue-800" href="{{route('login')}}"> {{__('traslate.registrer.acounte_1')}}</a></span></p>
    </div>
</div>
