...
<div class="flex justify-center">
    <div class="w-full  flex flex-col items-center md:flex-row">
        <div class="w-8/12 lg:w-6/12 sm:flex sm:justify-items-center md:flex md:justify-end">
            ...
            <img class="rounded-full w-44 h-44 md:w-60 md:h-60 mx-auto my-auto md:mx-px border-style"
                src="{{ asset('img/usuario.svg') }}">
            @else
            <img class="mx-auto my-auto md:mx-px md:content-end rounded-full w-44 h-44 md:w-60 md:h-60 object-cover object-top border-style"
...
<section class="container mx-auto mt-10">
    ...
    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:lg:grid-cols-3 gap-4">
        @foreach($posts as $post)
        <div
            class="relative overflow-hidden aspect-square group transition-transform transform hover:scale-105 shadow-2xl">
            <a href="{{ route('post.show', ['post' => $post, 'user' => $user]) }}">
                <img class="object-cover object-top w-full h-full" src="{{ asset('upload') . '/' . $post->imagen }}"
                    alt="img_post">
            </a>
